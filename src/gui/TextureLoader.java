...
public class TextureLoader {
    ...
    private BufferedImage loadImage(String ref) throws IOException {
        ...
        Image img = ImageIO.read(new File(ref));//new ImageIcon(url).getImage();
        BufferedImage bufferedImage = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB_PRE);
