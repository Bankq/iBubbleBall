...
public class Wall extends ConcreteItem implements Unmovable, RectangleArea{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1084678278833714885L;
	 ...
	 * @param vertex
	 */
	public Wall(Position pos, Position[] vertex) {
		super(pos);
		this.vertex = vertex;
	}
	
	/**
	 * The walls never disappear. So this method always return false
	 */
	...
	/**
	 * The walls never disappear. So this method does nothing.
	 */
