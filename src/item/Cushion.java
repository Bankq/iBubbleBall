...
public class Cushion extends ConcreteItem implements RectangleArea{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1459416251432992894L;
	private Position[] vertex;
	
	/**
	 * Default Constructor.
	 * Vertex is set to null
	 */
	public Cushion() {
		super();
		vertex = null;
	 ...
	 * @param vertex
	 */
	public Cushion(Position pos, Position[] vertex) {
		super(pos);
		this.vertex = vertex;
	}
	...
	public Object clone() throws CloneNotSupportedException {
		Cushion cloned = (Cushion) super.clone();
