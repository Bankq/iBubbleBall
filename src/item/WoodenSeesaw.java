...
public class WoodenSeesaw extends WoodenItem{
	/**
	 * 
	 */
	private static final long serialVersionUID = -4622767406339032499L;
	public static final int vertexCnt = 7;
	 ...
	 * @param pos
	 */
	public WoodenSeesaw(Position pos) {
		super(pos);
		vertex = null;
	}
	 ...
	 * @param vertex
	 */
	public WoodenSeesaw(Position pos, Position[] vertex) {
		super(pos);
		this.vertex = vertex;
	}
	...
	public void setVertex(Position[] vertex) {
		if (vertex.length != vertexCnt) System.err.println("Warning in setVertex(): length of the given array is less than vertexCnt");
	...
	public Object clone() throws CloneNotSupportedException {
		WoodenSeesaw cloned = (WoodenSeesaw) super.clone();
