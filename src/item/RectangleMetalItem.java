...
public class RectangleMetalItem extends MetalItem implements RectangleArea{
	/**
	 * 
	 */
	private static final long serialVersionUID = 8908214299047210324L;
	private Position[] vertex;
	
	/**
	 * Default constructor
	 */
	public RectangleMetalItem() {
		super();
		vertex = null;
	}
	 ...
	 * @param pos
	 */
	public RectangleMetalItem(Position pos) {
		super(pos);
		vertex = null;
	}
	 ...
	 * @param vertex
	 */
	public RectangleMetalItem(Position pos, Position[] vertex) {
		super(pos);
		this.vertex = vertex;
	}
	...
	public Object clone() throws CloneNotSupportedException {
		RectangleMetalItem cloned = (RectangleMetalItem) super.clone();
